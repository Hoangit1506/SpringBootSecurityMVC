...
public class UserRegistrationDto {
	@Size(min = 5, max = 30,
			message = "Your password '${validatedValue}' must be between {min} and {max} characters long")
	private String password;
	
	@Size(min = 5, max = 15,
			message = "Your username '${validatedValue}' must be between {min} and {max} characters long")
	...
	@Size(min = 10, max = 25,
			message = "Your email '${validatedValue}' must be between {min} and {max} characters long")
	...
	public String toString() {
		return "UserRegistrationDto [password=" + password + ", username=" + username + ", firstName=" + firstName
